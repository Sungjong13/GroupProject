...
function createSearchList() {
  var searchtermlist = document.getElementById("searchtermlist");
  var stringItem = "";
  for (const [key, value] of Object.entries(term_dict)) {
    strFrag =
      '<li class="list-group-item" searchterm="' +
      value +
      '">' +
      key +
      '<span class="badge badge-primary badge-pill"></span>' +
      "</li>";
    stringItem = stringItem.concat(strFrag);
  }
  searchtermlist.innerHTML = stringItem;
}
